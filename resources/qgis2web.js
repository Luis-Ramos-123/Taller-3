...
map.getView().fit([-10979852.460561, -2177734.334688, -5139312.105356, 4065.376833], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Departamentos del Peru </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (13 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '@Luis Ramos  ';
            }
